...
package src.generalType2zSlices.system;

import src.generalType2zSlices.sets.GenT2zMF_CylExtension;
import src.generalType2zSlices.sets.GenT2zMF_Intersection;
...
import src.type1.sets.T1MF_Meet;
...
public class GenT2z_Rule
{
    ...
    /**********************************************
     *
     *      BELOW: OR WOULD IT BE MORE SUITABLE TO CALCULATE THE INTERSECTION OF ALL ENTECEDENTS AT THE BEGINNING AND THEN 
...
//                as[a].setInput(this.getAntecedents()[a].getInput());
            }
