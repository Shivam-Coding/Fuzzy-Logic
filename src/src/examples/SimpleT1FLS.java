...
import src.type1.system.T1_Antecedent;
import src.type1.system.T1_Consequent;
import src.type1.system.T1_Rule;
import src.type1.system.T1_Rulebase;
...
public class SimpleT1FLS 
{
    ...
    public SimpleT1FLS()
    {
        ...
        T1MF_Triangular nice = new T1MF_Triangular("mf for nice", 0.0, 0.0, 10);
        plotMFs("try mf",new T1MF_Interface[]{nice}, food.getDomain(), 100);
