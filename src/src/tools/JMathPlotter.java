...
import src.generalType2zSlices.sets.GenT2zMF_Interface;
import src.generalType2zSlices.sets.GenT2zMF_Trapezoidal;
import src.generalType2zSlices.sets.GenT2zMF_Triangular;
import src.generic.Tuple;
import src.intervalType2.sets.IntervalT2MF_Interface;
import src.intervalType2.sets.IntervalT2MF_Trapezoidal;
...
import src.mathPlot.plot.Plot2DPanel;
import src.mathPlot.plot.Plot3DPanel;
import src.type1.sets.T1MF_Interface;
import src.type1.sets.T1MF_Trapezoidal;
...
public class JMathPlotter {
    ...
    public void plotMF(String plotName, T1MF_Interface set, int xDisc, Tuple xAxisRange, Tuple yAxisRange, boolean addExtraEndpoints)
    {
        ...
        if(plot==null)
        {
            ...
            /* try Shivam
            ((Plot2DPanel)plot).removeLegend();
            ((Plot2DPanel)plot).removePlotToolBar();
             // end try */
    ...
    public void plotMF(String plotName, IntervalT2MF_Interface set, int xDisc, JFrame frame, boolean addExtraEndpoints)
    {
      ...
      //  int upper = ((Plot2DPanel)plot).addLinePlot(set.getName()+"_upper",Color.BLUE, x, y1);
      //  int lower = ((Plot2DPanel)plot).addLinePlot(set.getName()+"_lower",Color.GREEN, x, y2);
...
//            z_Lower2[z_Lower.length-1] = 0.0 ;              
   ...
   private void setPlotAxisProperties()
   {
    ...
    public void previewPlotMF(String plotName, IntervalT2MF_Interface set, int xDisc, JFrame frame, boolean addExtraEndpoints, boolean legend)
    {
        double[] x = discretize(set.getSupport(),xDisc);
        double[] y1 = new double[xDisc];
        double[] y2 = new double[xDisc];
