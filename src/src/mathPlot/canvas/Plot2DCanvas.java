...
import java.awt.*;
import static src.mathPlot.canvas.PlotCanvas.ZOOM;

import src.mathPlot.plotObject.*;
import src.mathPlot.plots.*;
import src.mathPlot.render.*;

import static src.mathPlot.plotObject.Base.*;
import static src.mathPlot.utils.Array.*;
import static src.mathPlot.utils.Histogram.*;
