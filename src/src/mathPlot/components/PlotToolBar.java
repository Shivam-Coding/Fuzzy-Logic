...
public class PlotToolBar extends JToolBar {
	...
	public PlotToolBar(PlotPanel pp) {
		...
		buttonCenter = new JToggleButton(new ImageIcon("/Users/shivamawasthi/Documents/Juzzy/Juzzy_V1-10_Source/Juzzy/src/mathPlot/icons/center.png"));
		buttonCenter.setToolTipText("Center axes");
		buttonCenter.setSelected(plotCanvas.ActionMode == PlotCanvas.TRANSLATION);

		buttonZoom = new JToggleButton(new ImageIcon("/Users/shivamawasthi/Documents/Juzzy/Juzzy_V1-10_Source/Juzzy/src/mathPlot/icons/zoom.png"));
		...
		buttonSetScales = new JButton(new ImageIcon("/Users/shivamawasthi/Documents/Juzzy/Juzzy_V1-10_Source/Juzzy/src/mathPlot/icons/scale.png"));
		buttonSetScales.setToolTipText("Set scales");

		buttonDatas = new JButton(new ImageIcon("/Users/shivamawasthi/Documents/Juzzy/Juzzy_V1-10_Source/Juzzy/src/mathPlot/icons/data.png"));
		buttonDatas.setToolTipText("Get datas");

		buttonSavePNGFile = new JButton(new ImageIcon("/Users/shivamawasthi/Documents/Juzzy/Juzzy_V1-10_Source/Juzzy/src/mathPlot/icons/topngfile.png"));
		buttonSavePNGFile.setToolTipText("Save graphics in a .PNG File");

		buttonReset = new JButton(new ImageIcon("/Users/shivamawasthi/Documents/Juzzy/Juzzy_V1-10_Source/Juzzy/src/mathPlot/icons/back.png"));
		...
		if (plotCanvas instanceof Plot3DCanvas) {
			if (buttonRotate == null) {
				buttonRotate = new JToggleButton(new ImageIcon("/Users/shivamawasthi/Documents/Juzzy/Juzzy_V1-10_Source/Juzzy/src/mathPlot/icons/rotation.png"));
